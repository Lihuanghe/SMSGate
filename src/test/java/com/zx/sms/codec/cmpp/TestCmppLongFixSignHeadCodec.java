...
public class TestCmppLongFixSignHeadCodec extends AbstractTestMessageCodec<CmppSubmitRequestMessage> {
	@Override
	...
	public void testCodecLong()
	{
		...
		msg.setMsgContent(new SmsTextMessage(signTxt+"移娃没理解您的问题2【温馨提示】移娃没理解您的问题3【温馨提示】移娃没理解您的问题4【温馨提示】移娃没理解您的问题5【温馨提示】移娃没理解您的问题6【",new SmsDcs((byte)8)));
