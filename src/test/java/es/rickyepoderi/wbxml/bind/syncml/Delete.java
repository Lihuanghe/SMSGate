...
@XmlRootElement(name = "Delete", namespace="SYNCML:SYNCML1.1")
public class Delete {
    ...
    @XmlElement(name = "Archive", namespace="SYNCML:SYNCML1.1")
    protected Archive archive;
    @XmlElement(name = "SftDel", namespace="SYNCML:SYNCML1.1")
