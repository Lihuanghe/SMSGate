...
@XmlRootElement(name = "SearchPairList")
public class SearchPairList {

    @XmlElement(name = "SearchElement", required = true)
    ...
    /**
     * Sets the value of the searchElement property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSearchElement(String value) {
