...
public class ConMLTest extends GenericDirectoryTester {
    ...
    @Test(groups = {"conml", "devinf", "type-if-always", "stream" })
    ...
    @Test(groups = {"conml", "devinf", "type-if-always", "event" })
