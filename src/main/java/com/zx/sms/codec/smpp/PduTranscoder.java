...
public interface PduTranscoder {
     ...
     */
    ByteBuf encode(Pdu pdu,ByteBufAllocator allocator) throws UnrecoverablePduException, RecoverablePduException;
     ...
     *      that is invalid or a terminating null byte wasn't found.
     */
    Pdu decode(ByteBuf buffer) throws UnrecoverablePduException, RecoverablePduException;
